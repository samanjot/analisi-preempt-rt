...
do
    ...
    sudo stress-ng --timer 1 --taskset 0 --timer-freq 100000 --timer-slack 0 --timeout 300 --metrics-brief --times -q & 
    sudo cyclictest -a 0 -p 99 -m -i 1000 -D300 -h 1000 --json=$DIR/cyclic_stress_${cores}cores.json -q &
    wait $!
