...
DIR=membench_random/$1

echo "Running membench random"
mkdir -p $DIR
...
do
    ...
    sudo taskset -c 0 ../../membench/membench -r | grep HESOCMARK > $DIR/t1-CPU0_interference_${cores}cores.txt & PID_TO_WAIT=$!
    wait $PID_TO_WAIT
